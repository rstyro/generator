...
public class Table implements java.io.Serializable,Cloneable {
	...
	String sqlNameRemovePrefixes; //add by linyj
	String sqlNameRemovePrefixesLower; //add by linyj
   ...
   public Column getRequiredColumnBySqlName(String sqlName) {
	 ...
	 * add by linyj
	 */
	public String getSqlNameRemovePrefixes() {
		if(StringHelper.isBlank(sqlNameRemovePrefixes)) {
	        return removeTableSqlNamePrefix(sqlName);
	    }else {
	    	return sqlNameRemovePrefixes;
	    }
	}

	public void setSqlNameRemovePrefixes(String sqlNameRemovePrefixes) {
		this.sqlNameRemovePrefixes = sqlNameRemovePrefixes;
	}
	 ...
	 * add by linyj
	 */
	public String getSqlNameRemovePrefixesLower() {
		if(StringHelper.isBlank(sqlNameRemovePrefixesLower)) {
	        return removeTableSqlNamePrefix(sqlName).toLowerCase();
	    }else {
	    	return sqlNameRemovePrefixesLower;
	    }
	}

	public void setSqlNameRemovePrefixesLower(String sqlNameRemovePrefixesLower) {
		this.sqlNameRemovePrefixesLower = sqlNameRemovePrefixesLower;
	}
