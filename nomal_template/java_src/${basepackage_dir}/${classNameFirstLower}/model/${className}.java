 ...
 *  the class-head as this ' public class ${className} extends CommonInfoModel implements java.io.Serializable  '
 */
...
//			return "";
//		}
//		return DateUtils.getDateString(get${column.columnName}(), FORMAT_${column.constantName});
//	}
//	public void set${column.columnName}String(String value) {
//		if(!StringUtils.isBlank(value)){
//			set${column.columnName}(DateUtils.stringToDate(value, FORMAT_${column.constantName}));
//		}
//	}
//	
//			</#if>
